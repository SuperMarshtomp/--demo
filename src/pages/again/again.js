            ...
            <View className='again' style={{ height: getWindowHeight() }}>
                ...
                <View className='again-tip-view'>
                    <View className='again-tip-name'>
                        <Text>尊敬的 {this.state.name} { this.state.sex == '男' ? '先生' : '女士'}</Text>
                    </View>
                    <View className='again-tip'>
                        <Text>您仅需选择以下信息即可完成办卡申请，申请信息将使用您近一年半内最近一次在我行申请办卡的信息，若您希望更新申请信息，可 <Text className='again-tip-blue'>填写完整信息</Text> 并重新办理。</Text>
                    </View>
                </View>
